...
const apiURL = "http://"+process.env.REACT_APP_SERVER_IP_PORT+"/api/workflow/readallwftemplate";
  ...
  <Container>
   ...
   <Container width= "40%"> 
          ...
          <Table style = {{ width : "100%"}}>
              <TableBody>
              <TableRow>  
              <TableCell size="medium"> <Typography variant="subtitle1">Workflow ID</Typography> </TableCell>
              <TableCell size="medium"> <Typography variant="subtitle1">Workflow Name</Typography> </TableCell>
              </TableRow>
